// 비디오를 웹브라우저에 노출하기 위한 플러그인입니다. 비디오 재생 플레이어의 일종이라 생각하시면 됩니다.
...
BV.init();
  BV.show(
    //{ type: "video/mp4",  src: "/common/assets/video/yoga02.mp4", ambient:true }
		  '/common/assets/video/yoga02.mp4', {ambient: true}
  );
