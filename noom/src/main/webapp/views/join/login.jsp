								...
								<div class="btn_div">
									<div class="col-md_11">
										...
										<input type="text" class="col-md-7"
											id="MB_ID" name="MB_ID" placeholder="ID"  />
									</div>

									<div class="col-md_11 login_pwd">
										<label class="col-md-5">User Pwd</label> <input class="col-md-7"
											type="password" id="MB_PW" name="MB_PW" placeholder="PASSWORD"  />
									</div>

									<div class="login_btn_area1">
										<a id="login" class="btn btn_border">로그인</a>
									</div>
									
									<div class="login_btn_area2">
										<a id="gojoin" class="btn btn_border">회원가입</a>
									</div>
								</div>
							</form>
