							...
							<form id="frm">
								<table class="board_view">
									...
									<thead>
										...
										<tr>
											<th scope="row">제목</th>
											<td colspan="5" class="detail_right detail_left"><input
												type="text" id="RV_TITLE" name="RV_TITLE" class="wdp_90"></input></td>
										</tr>
										<tr>
											<th scope="row">작성자</th>
											<td colspan="5" class="detail_right detail_left"><input
												type="hidden" name="MB_CODE" id="MB_CODE"
												value="${loginInfo.MB_CODE}" /> ${loginInfo.MB_ID}</td>
										</tr>
									</thead>
									<tbody>
										...
										<tr>
											<td colspan="6" id="writearea"><textarea rows="20"
													cols="100" title="내용" id="RV_BODY" name="RV_BODY"></textarea>
											</td>
										</tr>
								...
								<div class="table_control">
									<div class="btns">
										<a href="#this" class="btn" id="write2"><span><strong>작성하기</strong></span></a>
									</div>
									<div class="btns">
