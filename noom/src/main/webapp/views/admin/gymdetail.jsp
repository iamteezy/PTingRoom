						...
						<div class="col-md-12 ">
							<div class="panel panel-headline">
								<div class="panel-heading">
									<div class="panel-heading">
										<h3 class="panel-title">가맹점 상세보기</h3>
									</div>
								</div>
								<div class="panel-body">
									...
									<div class="col-lg-7 col-md-7">
										<div class="col-sm-11">
											<h5 class="col-sm-4 detailhead">
												<strong>상호명</strong>
											</h5>
											<div class="col-sm-8 detailinfo">${GYMMAP.GY_NAME }</div>
										</div>
										<div class="col-sm-11">
											<h5 class="col-sm-4 detailhead">
												<strong>사업자번호</strong>
											</h5>
											<div class="col-sm-8 detailinfo">${GYMMAP.GY_NUM }</div>
										</div>
										<div class="col-sm-11">
											<h5 class="col-sm-4 detailhead">
												<strong>대표번호</strong>
											</h5>
											<div class="col-sm-8 detailinfo">${GYMMAP.GY_PHONE }</div>
										</div>
										...
										<div class="col-sm-11">
											...
											<div class="col-sm-8 detailinfo">${GYMMAP.GY_ADDR1 }&nbsp;${GYMMAP.GY_ADDR2 }&nbsp;${GYMMAP.GY_NAME }</div>
										</div>
										...
										<div class="col-sm-11">
											...
											<div class="col-sm-8 detailinfo">${GYMMAP.GY_POST }</div>
										</div>
									</div>
								</div>
								<div class="panel-body">
									<div class="centerGallery">
										<div class="row col-md-12 img12" id="lightgallery">
											<div class="col-md-5 gymimg">
												<img src="/common/gymfile/${GYMMAP.GY_NUM}_1.jpg"
													class="img-responsive">

											</div>

											<div class="col-md-5 gymimg">
												<img src="/common/gymfile/${GYMMAP.GY_NUM}_2.jpg"
													class="img-responsive">
								...
								<div class="panel-body">
									<div class="col-lg-7 col-md-7">
										<div class="col-sm-11">
											...
											<div class="col-sm-8 detailinfo">${GYMMAP.GY_CNAME }</div>
										</div>

										<div class="col-sm-11">
											<h5 class="col-sm-4 detailhead">
												<strong>코치 인사말</strong>
											</h5>
											<div class="col-sm-8 detailinfo">${GYMMAP.GY_CINTRO }</div>
										</div>
									</div>
								</div>
								<div class="panel-body">
									...
									<div class="centerGallery">
										<div class="row col-md-12 img12" id="lightgallery">
											<div class="col-md-5 gymimg">
												<img src="/common/gymfile/${GYMMAP.GY_NUM}_3.jpg"
													class="img-responsive">
											</div>
										</div>
									</div>
									<input type="hidden" id="curPage" value="${curPage}" /> <input
										type="hidden" id="searchType" value="${searchType}" /> <input
										type="hidden" id="searchWord" value="${searchWord}" />

								</div>
								<div class="table_control indetail panel-body">
									<div class="btns">
										<a href="#this" class="btn" id="list2">목록으로</a>
									</div>
									<div class="btns">
