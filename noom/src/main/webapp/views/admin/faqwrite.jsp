						...
						<div class="col-md-12">
							<div class="panel panel-headline">
								<div class="panel-heading">
									<div class="panel-heading">
										<h3 class="panel-title">FAQ등록하기</h3>
									</div>
								</div>
									...
									<form id="frm">
										<table class="table table-striped">
											...
											<tbody>
												...
												<tr>
													<th scope="row">제목</th>
													<td><input type="text" id="FAQ_TITLE" name="FAQ_TITLE"
														class="noticeinput"></input> <input type="hidden"
												...
												<tr>
													...
													<td><textarea class="noticeinput" rows="20" cols="100"
															title="내용" id="FAQ_BODY" name="FAQ_BODY"></textarea></td>
												</tr>
										...
										<div class="table_control indetail">
											<div class="btns">
												<a href="#this" class="btn" id="f_write2">작성하기</a>
											</div>
											<div class="btns">
