						...
						<div class="col-md-12">
							<div class="panel panel-headline">
								<div class="panel-heading">
									<div class="panel-heading">
										<h3 class="panel-title">FAQ수정하기</h3>
									</div>
								</div>
								<div class="panel-body">
									...
									<form id="frm">
										<table class="table table-striped">
											...
											<tbody>
												<tr>
													<th scope="row">글번호</th>
													<td>${FAQMAP.FAQ_NUM }<input type="hidden"
														id="FAQ_NUM" name="FAQ_NUM" value="${FAQMAP.FAQ_NUM }">
													</td>
												</tr>
												<tr>
													<th scope="row">제목</th>
													<td><input type="text" class="noticeinput"
														id="FAQ_TITLE" name="FAQ_TITLE" class="wdp_90"
														value="${FAQMAP.FAQ_TITLE }"> <input type="hidden"
														name="ADM_ID" id="ADM_ID" value="${admloginInfo.ADM_ID}" /></td>
												</tr>
												<tr>
													<th scope="row">본문</th>
													<td><textarea class="noticeinput" rows="20" cols="100"
															title="내용" id="FAQ_BODY" name="FAQ_BODY">${FAQMAP.FAQ_BODY }</textarea>
													</td>
												</tr>
											</tbody>
										</table>
									...
									<div class="table_control indetail">
										<div class="btns">
											<a href="#this" class="btn" id="f_list1">목록으로</a>
										</div>
										<div class="btns">
											<a href="#this" class="btn" id="f_update2">저장하기</a>
										</div>
									</div>
