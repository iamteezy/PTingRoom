						...
						<div class="col-md-12">
							<div class="panel panel-headline">
								<div class="panel-heading">
									<div class="panel-heading">
										<h3 class="panel-title">상품수정하기</h3>
									</div>
								</div>
									...
									<form id="frm">
										<table class="table table-striped">
											...
											<tbody>
												...
												<tr>
													<th scope="row">상품명</th>
													<td>${PDMAP.PD_NAME }<input type="hidden" id="PD_NAME"
														name="PD_NAME" value="${PDMAP.PD_NAME }">

													</td>
												</tr>
												<tr>
													<th scope="row">상품가격</th>
													<td><input type="text" id="PD_PRICE" name="PD_PRICE"
														value="${PDMAP.PD_PRICE }" class="pdinput"></input></td>
												</tr>
												<tr>
													<th scope="row">상품설명</th>
													<td><textarea class="pdinput" rows="5" cols="100"
															title="내용" id="PD_BODY" name="PD_BODY">${PDMAP.PD_BODY }</textarea>
													</td>
												</tr>
												<input type="hidden" id="curPage" value="${PDMAP.curPage}" />
												<input type="hidden" id="searchType"
													value="${PDMAP.searchType}" />
												<input type="hidden" id="searchWord"
													value="${PDMAP.searchWord}" />

											</tbody>
										</table>
										<div class="table_control indetail">
											<div class="btns">
												<a href="#this" class="btn" id="updatepd">수정하기</a>
											</div>
											<div class="btns">
												<a href="#this" class="btn" id="listpd2">목록으로</a>
											</div>
										</div>
									</form>
