						...
						<div class="col-md-12">
							<div class="panel panel-headline">
								<div class="panel-heading">
									<div class="panel-heading">
										<h3 class="panel-title">공지사항등록하기</h3>
									</div>
								</div>
											...
											<tbody>
												...
												<tr>
													...
													<td><input type="text" class="noticeinput"
														id="NT_TITLE" name="NT_TITLE" class="wdp_90"></input> <input
														type="hidden" name="ADM_ID" id="ADM_ID"
														value="${admloginInfo.ADM_ID}" /></td>
												</tr>
												<tr>
													<th scope="row">본문</th>
													<td><textarea class="noticeinput" rows="20" cols="100"
															title="내용" id="NT_BODY" name="NT_BODY"></textarea></td>
												</tr>
