						...
						<div class="col-md-12">
							<div class="panel panel-headline">
								<div class="panel-heading">
									<div class="panel-heading">
										<h3 class="panel-title">공지사항수정하기</h3>
									</div>
								</div>
								<div class="panel-body">
									...
									<form id="frm">
										<table class="table table-striped">
											...
											<tbody>
												<tr>
													<th scope="row">글번호</th>
													<td class="revise">${NTMAP.NT_NUM }<input
														type="hidden" id="NT_NUM" name="NT_NUM"
														value="${NTMAP.NT_NUM }"></td>
												...
												<tr>
													<th scope="row">제목</th>
													<td colspan="3"><input type="text" class="noticeinput"
														id="NT_TITLE" name="NT_TITLE" class="wdp_90"
														value="${NTMAP.NT_TITLE }"> <input type="hidden"
														name="ADM_ID" id="ADM_ID" value="${admloginInfo.ADM_ID}" />

													</td>
												</tr>
												<tr>
													<th scope="row">본문</th>
													<td colspan="3"><textarea class="noticeinput"
															rows="20" cols="100" title="내용" id="NT_BODY"
															name="NT_BODY">${NTMAP.NT_BODY }</textarea></td>
												</tr>
											</tbody>
										</table>
									</form>
									<div class="table_control indetail">
										<div class="btns">
											<a href="#this" class="btn" id="list1">목록으로</a>
										</div>
										<div class="btns">
											<a href="#this" class="btn" id="update2">저장하기</a>
										</div>
									</div>
